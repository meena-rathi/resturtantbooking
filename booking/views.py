...
def delete_booking(request, booking_id):
    ...
    if request.method == 'POST':
        reservation.delete()
        messages.success(request, 'Booking has been deleted. We hope you will stay with us again!')
...
def menu(request):
    lunch_items = [
        ...
        {"image": "image/lunch3.jpg", "description": "Cheese Paratha $15"},
        {"image": "image/lunch4.jpg", "description": "White rice with curry $20"},
        {"image": "image/lunch5.jpg", "description": "Sandwich $20"},
        {"image": "image/lunch6.jpg", "description": "Vegetable Thali $20"},
        {"image": "image/lunch7.jpg", "description": "Biryani $15"},
        {"image": "image/lunch8.jpg", "description": "Naan and paneer $20"},
    ]
    dinner_items = [
        {"image": "image/dinner1.jpg", "description": "Idli with chutney $20"},
        {"image": "image/dinner2.webp", "description": "Mix vegetables with rice $20"},
        {"image": "image/dinner3.jpg", "description": "Masala Dosa $10"},
        {"image": "image/dinner4.jpg", "description": "Naan Daal $20"},
        {"image": "image/dinner5.jpg", "description": "Vegetable rice $20"},
        {"image": "image/dinner6.jpg", "description": "Vegetable Pasta $20"},
        {"image": "image/dinner7.jpg", "description": "Biryani $15"},
        {"image": "image/dinner8.jpg", "description": "Rice"},
    ]
    drink_items = [
        {"image": "image/drink1.webp", "description": "Lemonade $5"},
        {"image": "image/drink2.webp", "description": "Margarita $5"},
        {"image": "image/drink3.jpg", "description": "Masala Dosa $10"},
        {"image": "image/drink4.jpg", "description": "Wine $8"},
        {"image": "image/drink5.jpg", "description": "Aperol Spritz $5"},
        {"image": "image/drink6.jpg", "description": "Mojito $4"},
        {"image": "image/lunch3.jpg", "description": "Cheese Paratha $15"},
        {"image": "image/lunch4.jpg", "description": "White rice with curry $20"},
    ]
